...
<div style="margin: 10px 0;"></div>
	<div class="easyui-layout" data-options="fit:true"
		style="margin: 10px 0;">
		<div data-options="region:'center',title:'盘存表'" style="width: 300px;">
			<table id="dg" class="easyui-datagrid"
				data-options="fitColumns:true,rownumbers:true, 
			singleSelect:true,
			url:'${pageContext.request.contextPath}/action/pancun/list',
			fit:true, 		
			toolbar: '#toolbar',
			showFooter:true,
			onSelect:dgsclick,
			...
			pageSize:20">
				<thead>
					<tr>
						...
						<th data-options="field:'storagerack',width:130">货架</th>
						<th data-options="field:'delivery',width:100">是否出库</th>
						<th data-options="field:'pid',width:100">数据库库存数量</th>
...
<script type="text/javascript">
	function doAdd() {
		addform("dlg_fm", "/action/pancun/add");
	...
	function doUpd() {
		...
		if (row == null)
			return;
		commonform("dlg_fm", "/action/pancun/update");
	...
	function doImp(){
		...
		addform("dlgimp_fm", "/action/pancun/imppancun");
	...
	function exportExcel(){
    	var url;
    	url='${pageContext.request.contextPath}/action/mobilepancun/expmobilepancun';
    	download_file(url);
	}
