...
<div style="margin: 10px 0;"></div>
	<div class="easyui-layout" data-options="fit:true"
		...
		<div data-options="region:'center',title:'电话卡列表'" style="width: 300px;">
			...
			singleSelect:true,
			url:'${pageContext.request.contextPath}/action/huanhuo/list',
			fit:true, 		
			toolbar: '#toolbar',
			showFooter:true,
			onSelect:dgsclick,
			...
			pageSize:20">
				<thead>
					<tr>
						...
						<th data-options="field:'time',width:100">换货时间</th>
						<th data-options="field:'barter',width:130">换货数量</th>
						<th data-options="field:'reality',width:100">实际数量</th>
						<th data-options="field:'testarticle',width:100">检品人</th>
...
<script type="text/javascript">
	function doAdd() {
		addform("dlg_fm", "/action/huanhuo/add");
	...
	function doUpd() {
		...
		if (row == null)
			return;
		commonform("dlg_fm", "/action/huanhuo/update");
	...
	function doImp(){
		...
		addform("dlgimp_fm", "/action/huanhuo/imphuanhuo");
	...
	function exportExcel(){
    	var url;
    	url='${pageContext.request.contextPath}/action/mobilehuanhuo/expmobilehuanhuo';
    	download_file(url);
	}
